...
namespace TierraCreative.Controllers.Utility
{
    public class Utilities
    {
            ...
            string submitUserEmail)
        {
            ...
            emailmodel.Body += "<p><img src=\"http://tierracreative.clientpreview.agency/Images/Logo.jpg\" width=\"240\" height=\"60\"></p>";
            ...
            string username)
        {
            ...
            var body = "<style type=\"text/css\">body{font-family:Verdana, Geneva, sans-serif;font-size:13px;line-height:19px;}table {border: solid #666 1px;font-size:13px;line-height:19px;}td {border: solid #666 1px;padding:5px;}</ style >";
            ...
            body += "<p><img src=\"http://tierracreative.clientpreview.agency/Images/Logo.jpg\" width=\"240\" height=\"60\"></p>";
